...
[ ! -f ./build/rollup-tx-test.zkey ] && npx snarkjs groth16 setup build/rollup-tx-test.r1cs build/powersOfTau28_hez_final_22.ptau build/rollup-tx-test.zkey
...
[ ! -f ./build/rollup.zkey ] && npx snarkjs groth16 setup build/rollup.r1cs build/powersOfTau28_hez_final_22.ptau build/rollup.zkey
