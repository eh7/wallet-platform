...
describe("Feedback", () => {
    ...
    describe("# sendFeedback", () => {
        it("Should allow users to send feedback anonymously", async () => {
            ...
            const feedback1 = encodeBytes32String("Hello World")
            const proof1 = await generateProof(users[1], group, feedback1, 12345)
            const transaction1 = await feedbackContract.sendFeedback(
